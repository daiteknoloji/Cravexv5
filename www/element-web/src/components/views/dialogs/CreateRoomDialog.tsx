...
export default class CreateRoomDialog extends React.Component<IProps, IState> {
    ...
    public constructor(props: IProps) {
        ...
        this.state = {
            ...
            isEncrypted: false, // HER ZAMAN FALSE - Admin mesajları görebilsin
            joinRule,
    ...
    public componentDidMount(): void {
        // ENCRYPTION DEVRE DIŞI - Her zaman false
        // UI'da gösterilmiyor, kullanıcı değiştiremez
        this.setState({
            canChangeEncryption: false,
            isEncrypted: false, // HER ZAMAN FALSE
        });
    ...
    private onEncryptedChange = (isEncrypted: boolean): void => {
        // ENCRYPTION HER ZAMAN FALSE - Değiştirilemez
    ...
    public render(): React.ReactNode {
        ...
        // ENCRYPTION UI KALDI - Admin her şeyi görebilsin diye
        // Şifreleme her zaman kapalı, UI'da gösterilmiyor
        let e2eeSection: JSX.Element | undefined = undefined;
